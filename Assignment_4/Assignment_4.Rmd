...
Chr21. The hg38 genome build had more reads for this chromosome. 
...
filter_bed3 <- bed3[c("chr_ori", "start_ori", "chr_nonDet","start_nonDet")]
canonical_chromosomes <- paste0("chr", 1:22)
filter_bed3 <- filter_bed3[filter_bed3$chr_ori %in% canonical_chromosomes, ]
filter_bed3 <- filter_bed3[filter_bed3$chr_nonDet %in% canonical_chromosomes,]
filter(filter_bed3, filter_bed3$chr_nonDet %in% canonical_chromosomes)
filter(filter_bed3, filter_bed3$chr_ori %in% canonical_chromosomes)
filter_bed3 = filter_bed3[filter_bed3$chr_ori == filter_bed3$chr_nonDet,]
ggplot(data = filter_bed3, aes(y = start_nonDet,x = start_ori)) + facet_wrap(~ chr_nonDet + chr_ori) + geom_point()
...
Contributions: Alice and Abhishek worked together asynchronously on the assignment together and then pushed the combined changes in the end, after a synchronous working session.
