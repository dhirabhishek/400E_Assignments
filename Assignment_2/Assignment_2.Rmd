...
# It sorting out based on the chromosome and the position of the genome 
...
#?# What happened? Enter your answer below - 1 pt
## Below is what it is printing when the above command is ran. So it looks like it was performing fastqc on the files we wanted it to run on. 
