...
Authors: Abhishek Dhir (87603866) and Alica Zhang (52721552)
...
###Talk about sequence duplication levels as well
...
#Using the htop command, we can see the processes runinng under the username along with other info that are shown with the processes running such as CPU% being used by that process, MEM% by the process, time since it's running. There is also the average CPU load that is being displayed.
htop
